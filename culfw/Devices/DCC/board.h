...
#define ANTSEL868_EXTERN() 	ANTSEL868_PORT|=_BV(ANTSEL868_PIN)
#define ANTSEL868_INTERN() ANTSEL868_PORT&=~_BV(ANTSEL868_PIN)

#define ANTSEL433_PORT          PORTC
#define ANTSEL433_PIN           PINC
#define ANTSEL433_BIT           4

#define ANTSEL433_EXTERN() 	ANTSEL433_PORT|=_BV(ANTSEL433_PIN)
#define ANTSEL433_INTERN() ANTSEL433_PORT&=~_BV(ANTSEL433_PIN)
